...
- [x] `R-PRODUCT-001` — PASS: Missing official asset correctly stops production; Generator did not fabricate one.
- [x] `R-ASSET-001` — PASS: Missing official asset correctly stops production; Generator did not fabricate one.
